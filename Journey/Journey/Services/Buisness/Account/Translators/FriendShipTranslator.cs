...
namespace Journey.Services.Buisness.Account.Translators
{
    public static class FriendShipTranslator
    {
        ...
        public static List<Models.Account.FriendShip> TranslateAccounts(List<AzureFriendShip> accounts)
        {
            try
            {
        ...
        public static Models.Account.FriendShip TranslateAccount(AzureFriendShip account)
        {
            try
            {
                var accountDto = new Models.Account.FriendShip();
